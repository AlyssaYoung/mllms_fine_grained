...
if __name__ == "__main__":
    ...
    parser.add_argument('--dinov3_feat_path', type=str, default="/root/autodl-tmp/dataset/zoom_eye_data/zoom_eye_data/dinov3_features/vstar/dinov3_mllm_patch_28.pt")
